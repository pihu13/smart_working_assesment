                                ...
                                <tbody>
                                    ...
                                    if ($product->product_type == "2") {
                                                ...
                                                <table id="dataTable3" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php echo (@$combination->price_sale_price) ? $current . $combination->price_sale_price : $current . "0.00"; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo (@$combination->product_discount) ? $combination->product_discount . "%" : "0%"; ?>
                                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo (@$product->price_sale_price) ? $current . @$product->price_sale_price : $current . "0.00"; ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th> Discount(%):</th>
                                            <td>
                                                <?php echo (@$product->product_discount) ? @$product->product_discount . "%" : "0%"; ?>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th> Product Default Value:</th>
                                            <td>{{ isset($product['product_default_value'])?$product['product_default_value']:"N/A" }}</td>
                                        </tr>
                                    <?php } ?>
