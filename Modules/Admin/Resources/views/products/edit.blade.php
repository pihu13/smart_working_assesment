...
<div class="main-content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('admin.edit.product.post') }}" id="add_pro_frm" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <input type="hidden" value="{{$product->slug}}" name="slug"/>
                <input type="hidden" value="{{$product->id}}" name="product_id" id="product_id" class="product_id" />
                <input type="hidden" value="{{ @$product->product_image }}" name="old_product_image"/>
                        ...
                        <select class="form-control" id="shop_id" name="shop_id">
                            ...
                            if (@$stores && count($stores) > 0) {
                                foreach ($stores as $store) {
                                    ?>
                                    <option value="{{ @$store->id }}" <?php echo (@$store->id == @$product->shop_id) ? 'selected="selected"' : ""; ?> >
                                        {{ @$store->store_name }}
                                    </option>
                                    <?php
                                }
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <input class="form-control" minlength="3" maxlength="100" id="title" name="title" type="text" value="{{ @$product->title }}" title="Title" placeholder="Please Enter Title" autocomplete="off">
                        @if ($errors->has('title'))
                ...
                <div class="form-group row">
                    <div class="col-md-12 appned_variation_sec">
                        @include('admin::products.product-variation-option-combination-edit')
                    </div>
                </div>
                @endif
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        if (isset($pro_thumbnail_img_db)) {
                            $img = $pro_thumbnail_img_db;
                ...
                if (@$product->product_type == "1") {
                    ...
                    <div class="form-group row price_section">
                        <div class="col-md-6">
                            ...
                            <input class="form-control" id="price" minlength="1" maxlength="10" name="price" type="text" value="{{ @$product->price }}" title="Price" placeholder="Please Enter Price" autocomplete="price">
                            @if ($errors->has('price'))
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control" id="sale_price" minlength="1" maxlength="10" name="sale_price" type="text" value="{{ @$product->sale_price }}" title="Sale Price" placeholder="Please Enter Sale Price" autocomplete="price">
                    ...
                    <div class="form-group row price_section">
                        <div class="col-md-12">
                            ...
                            <input class="form-control" id="stock" minlength="1" maxlength="5" name="stock" type="text" value="{{ @$product->stock }}" title="Stock" placeholder="Please Enter Stock" autocomplete="stock">
                            @if ($errors->has('stock'))
...
<!--                        <div class="col-md-6">
                            ...
                            <input class="form-control product_tax" id="product_tax" minlength="1" maxlength="10" name="product_tax" type="text" value="{{ (@$product->product_tax)?$product->product_tax:"0" }}" title="Product Tax" placeholder="Please Enter Product Tax" autocomplete="off">
                    ...
                    <div class="form-group row price_section">
                        <div class="col-md-12">
                            ...
                            <input class="form-control" id="stock" minlength="1" maxlength="255" name="product_default_value" type="text" value="{{ (@$product->product_default_value)?$product->product_default_value:"0" }}" title="Stock" placeholder="Please Product Default Value" autocomplete="off">
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <input class="form-control" id="sku" minlength="1" maxlength="255" name="sku" type="text" value="{{ @$product->sku }}" title="SKU" placeholder="Please Enter SKU" autocomplete="off">
                        @if ($errors->has('sku'))
                ...
                <div class="form-group row">
                    <div class="col-md-12 select2cuscls">
                        ...
                        <select class="form-control form-control-lg" id="category_id" name="category_id[]" multiple="multiple">
                            ...
                            <option value="{{$category->id}}" <?php echo (@in_array($category->id, $catArr)) ? 'selected="selected"' : ""; ?>>
                                {{$category->name}}
                            </option>
                            @foreach ($category->children as $child)
                            <option value="{{$child->childCat->id}}" <?php echo (@in_array($child->childCat->id, $catArr)) ? 'selected="selected"' : ""; ?>>
                                -{{ $child->childCat->name }}
                            </option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <textarea class="form-control" maxlength="1000" id="description" name="description">{{ @$product->description }}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <textarea class="form-control" minlength="1" maxlength="1000" id="short_description" name="short_description">{{ @$product->short_description }}</textarea>
                        <span>Max Characters limit 1000</span>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <div class="form-check form-check-inline form-check-sm mr-2">
                            <input type="radio"  class="form-check-input" id="inline-radio1" name="status" value="1" <?php echo (@$product->status == "1") ? 'checked="checked"' : ""; ?>>
                            <label class="form-check-label" for="inline-radio1">Active</label>
                        </div>
                        <div class="form-check form-check-inline form-check-sm mr-2">
                            <input type="radio" class="form-check-input" id="inline-radio2"" name="status" value="0" <?php echo (@$product->status == "0") ? 'checked="checked"' : ""; ?>>
...
<style type = "text/css">
    ...
    .slider_img_cls{}
    .slider_img_cls .col-sm-2{padding-left: 7.5px; padding-right: 7.5px; padding-bottom: 15px;}
    .pro_img_sec img{width: 100%;}
</style>
    ...
    jQuery(document).ready(function () {
        ...
        jQuery('.upload-slider-image').on('click', function (ev) {
            resize.croppie('result', {
                ...
                jQuery.ajax({
                    ...
                    type: "POST",
                    data: {_token: '{{ csrf_token() }}', "image": img, "product_id": product_id},
                    dataType: "json",
                    beforeSend: function () {
        ...
        jQuery(document).on("click", ".remove-slider-image", function () {
            ...
            jQuery.ajax({
                ...
                type: "POST",
                data: {_token: '{{ csrf_token() }}', "imgId": imgId, "product_id": product_id},
        ...
        jQuery(document).on("click", ".remove-slider-image-db", function () {
            var imgId = jQuery(this).attr("data-id");
            var product_id = jQuery(this).attr("data-proid");
            jQuery.ajax({
                url: "{{route('admin.remove.product.slider.image.db')}}",
                type: "POST",
                data: {_token: '{{ csrf_token() }}', "imgId": imgId, "product_id": product_id},
                dataType: "json", beforeSend: function () {
                    jQuery(".loading-box").show();
...
@include('admin::products.combination-script-css-edit')
@endsection
