...
<div class="main-content">
    ...
    <div class="card">
        <div class="card-header">
            <strong>Add CMS Page</strong>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.add.page.post') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="name">Title <span style="color:red;">*</span></label>
                            <input class="form-control" id="title" name="title" type="text" minlength="1" maxlength="255" title="Title" placeholder="Please Enter Page Title" autocomplete="off" value="{{ old('title') }}">
                            @if ($errors->has('title'))
