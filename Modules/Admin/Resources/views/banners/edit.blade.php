...
<div class="main-content">
    ...
    <div class="card">
        ...
        <form action="{{ route("admin.edit.banner.post") }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <input type="hidden" name="slug" id="slug" value="{{ @$banner->id }}" />
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="title" name="title" minlength="1" maxlength="100" type="text" title="Store Name" placeholder="Please Enter Title" autocomplete="off" value="{{ @$banner->title }}">
                            @if ($errors->has('title'))
                    ...
                    ?>
                    <input type="hidden" name="banner_image_db" id="banner_image_db" value="" class="form-control">
                    <input type="hidden" name="banner_image_db_old" id="banner_image_db_old" value="{{ @$banner->banner_image }}" class="form-control">
                    <div class="col-sm-3">
                        <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" minlength="1" maxlength="100" id="content" name="content">{{ @$banner->content }}</textarea>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline form-check-sm mr-2">
                                <input type="radio"  class="form-check-input" id="inline-radio1" name="status" value="1" <?php echo (@$banner->status == "1") ? 'checked="checked"' : ""; ?>>
                                <label class="form-check-label" for="inline-radio1">Active</label>
                            </div>
                            <div class="form-check form-check-inline form-check-sm mr-2">
                                <input type="radio" class="form-check-input" id="inline-radio2" name="status" value="0" <?php echo (@$banner->status == "0") ? 'checked="checked"' : ""; ?>>
