...
<div class="main-content">
    <div class="page-title col-sm-12">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3 m-0">Product Return Order</h1>
            </div>
            <div class="col-md-6">
    ...
    <div class="col-sm-12">
        <div class="row">
            <div class="col-sm-12 mb-4">
                <form class="box bg-white" method="GET" action="{{ route('admin.product.return.orders') }}" files="true">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action" style="float: left;">
                                            <a class="icon-btn preview" href="{{ route('admin.view.product.return.order',[$order->order_number]) }}">		
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery(".reset-frm").on("click", function () {
            window.location.href = '<?php echo route('admin.product.return.orders'); ?>';
        });
        jQuery(document).ready(function () {
            jQuery(function () {
