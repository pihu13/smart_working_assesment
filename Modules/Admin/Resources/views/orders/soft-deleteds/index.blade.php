...
<div class="main-content">
    <div class="page-title col-sm-12">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3 m-0">Product Soft Delete Order</h1>
            </div>
            <div class="col-md-6">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">All Soft Delete Order</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="col-sm-12">
        <div class="row">
            <div class="col-sm-12 mb-4">
                <form class="box bg-white" method="GET" action="{{ route('admin.product.softdelete.orders') }}" files="true">
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                All Soft Delete Order List
                <a href="{{route('admin.product.orders')}}">
                    <span class="badge badge-primary float-right mr-2">All Orders</span>
                </a>
                            ...
                            <table id="dataTable" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr class="remove_row_{{$order->id}}">
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" onclick="restoreDelete('<?php echo @$order->id; ?>',<?php echo @$order->id; ?>, '<?php echo @$order->order_number; ?>');" class="actions" data-slug="<?php echo @$order->id; ?>">
                                                <span class="badge badge-success">Restore</span>
                                            </a>
                                        </td>
                                        <td class="action" style="float: left;">
                                            <a class="icon-btn preview" href="{{ route('admin.view.product.softdelete.order',[$order->order_number]) }}">		
...
<script type="text/javascript">
    function confirmDelete(dataSlug, row_id, order_number) {
        ...
        swal({
            ...
            if (!isConfirm)
                return;
            jQuery.ajax({
                url: '{{ route("admin.permanently.delete.product.order") }}',
                type: "POST",
                ...
                success: function (response) {
                    ...
                    if (response.status == "200") {
                        ...
                        swal("Done!", "Product order successfully permanently deleted in system!", "success");
                    } else {
    ...
    function restoreDelete(dataSlug, row_id, order_number) {
        var this_id = row_id;
        swal({
            title: "Are you sure?",
            text: "You won't be able to revert this!",
            ...
            if (!isConfirm)
                return;
            jQuery.ajax({
                url: '{{ route("admin.restore.product.order") }}',
                type: "POST",
                data: {_token: '{{ csrf_token() }}', slug: dataSlug, order_number: order_number},
                dataType: "json",
                beforeSend: function () {
                ...
                success: function (response) {
                    ...
                    if (response.status == "200") {
                        ...
                        swal("Done!", "Product order restore successfully!", "success");
                    } else {
                        swal("Error deleting!", "Please try again", "error");
                    }
                    jQuery(".loading-box").hide();
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery(".reset-frm").on("click", function () {
            window.location.href = '<?php echo route('admin.product.softdelete.orders'); ?>';
        });
        jQuery(document).ready(function () {
            jQuery(function () {
