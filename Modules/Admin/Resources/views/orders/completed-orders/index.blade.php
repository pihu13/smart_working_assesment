...
<div class="main-content">
    <div class="page-title col-sm-12">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3 m-0">Product Completed Order</h1>
            </div>
            <div class="col-md-6">
    ...
    <div class="col-sm-12">
        <div class="row">
            <div class="col-sm-12 mb-4">
                <form class="box bg-white" method="GET" action="{{ route('admin.product.completed.orders') }}" files="true">
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{route('admin.product.softdelete.orders')}}">
                    <span class="badge badge-primary float-right mr-2">Soft Delete Orders</span>
                </a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if (@$order->order_status == "2") {
                                                ...
                                                echo '<span class="badge badge-success">' . strtoupper('Refuned') . '</span>';
                                        ...
                                        <td class="action" style="float: left;">
                                            <a class="icon-btn preview" href="{{ route('admin.view.product.completed.order',[$order->order_number]) }}">		
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery(".reset-frm").on("click", function () {
            window.location.href = '<?php echo route('admin.product.completed.orders'); ?>';
        });
        jQuery(document).ready(function () {
            jQuery(function () {
