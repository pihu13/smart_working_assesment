            ...
            <div class="col-md-6">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.product.cancel.orders')}}">Cancel Order Manager</a></li>
                            ...
                            <table id="dataTable" class="table table-striped table-bordered table-hover">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Cancel Reason:</th>
                                        <td>
                                            {{ (@$order->orderCancelReason->reasons)?@$order->orderCancelReason->reasons:"N/A" }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Cancel Comment:</th>
                                        <td>
                                            {{ (@$order->orderCancelReason->comments)?@$order->orderCancelReason->comments:"N/A" }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
