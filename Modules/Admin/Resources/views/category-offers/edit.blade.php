...
<div class="main-content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('admin.edit.offer.post') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <input type="hidden" name="slug" id="slug" value="{{ @$offer->id }}" />
                <div class="row">
                    <div class="col-sm-6">
                            ...
                            <select name="category_id" id="category_id" class="form-control">
                                ...
                                if (@$categories && count($categories) > 0) {
                                    foreach ($categories as $category) {
                                        ?>
                                        <option value="{{ @$category->id }}" <?php echo (@$offer->category_id == @$category->id)?'selected="selected"':""; ?>>
                                            {{ @$category->name }}
                                        </option>
                                        <?php
                                    }
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="title" value="{{ @$offer->title }}" name="title" minlength="1" title="Title" maxlength="100" type="text" placeholder="Enter Title" autocomplete="off">
                            @if ($errors->has('title'))
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="offer_type" name="offer_type">
                                <option value="1" <?php echo (@$offer->offer_type == "1")?'selected="selected"':""; ?>>Fixed</option>
                                <option value="2" <?php echo (@$offer->offer_type == "2")?'selected="selected"':""; ?>>Percentage</option>
                            </select>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="price_discount" value="{{ @$offer->price_discount }}" id="price_discount" title="Price Discount" minlength="1" maxlength="3" class="form-control" placeholder="Please enter price discount">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="banner_type" name="banner_type">
                                <option value="1" <?php echo (@$offer->banner_type == "1")?'selected="selected"':""; ?>>Full</option>
                                <option value="2" <?php echo (@$offer->banner_type == "2")?'selected="selected"':""; ?>>Small</option>
                            </select>
                    ...
                    <input type="hidden" name="full_banner_img_db_old" id="full_banner_img_db_old" value="{{ @$offer->banner_img }}" class="form-control">
                    ...
                    <input type="hidden" name="small_banner_img_db_old" id="small_banner_img_db_old" value="{{ @$offer->banner_img }}" class="form-control">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="valid_from_date" id="valid_from_date" value="{{ @$offer->valid_from_date }}" title="Valid From Date" class="form-control" placeholder="Please enter valid from date">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="valid_to_date" id="valid_to_date" value="{{ @$offer->valid_to_date }}" title="Valid To Date" class="form-control" placeholder="Please enter valid to date">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline form-check-sm mr-2">
                                <input type="radio"  class="form-check-input" id="inline-radio1" name="status" <?php echo (@$offer->status == "1") ? 'checked="checked"' : ""; ?> value="1"  >
                                <label class="form-check-label" for="inline-radio1">Active</label>
                            </div>
                            <div class="form-check form-check-inline form-check-sm mr-2">
                                <input type="radio" class="form-check-input" id="inline-radio2"" name="status" <?php echo (@$offer->status == "0") ? 'checked="checked"' : ""; ?> value="0" >
