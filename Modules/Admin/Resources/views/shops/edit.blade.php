...
<div class="main-content">
    ...
    <div class="card">
        ...
        <form action="{{ route("admin.edit.shop.post") }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <input type="hidden" name="slug" id="slug" value="{{ @$shop->slug }}" />
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="name">Name <span style="color:red;">*</span></label>
                            <input class="form-control" id="store_name" name="store_name" type="text" title="Store Name" placeholder="Please Enter Store Name" autocomplete="off" value="{{ @$shop->store_name }}">
                    ...
                    ?>
                    <input type="hidden" name="store_logo_db" id="store_logo_db" value="" class="form-control">
                    <input type="hidden" name="store_logo_db_old" id="store_logo_db_old" value="{{ @$shop->store_logo }}" class="form-control">
                    <div class="col-sm-3">
                        <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="store_owner_name" name="store_owner_name" type="text" title="Store Name" placeholder="Please Enter Store Owner Name" autocomplete="off" value="{{ @$shop->store_owner_name }}">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="store_name" name="store_email" type="text" title="Store Email" placeholder="Please Enter Store Email" autocomplete="off" value="{{ @$shop->store_email }}">
                    ...
                    <div class="col-sm-6 phone_number_sec">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="phone_number" name="store_contact_no" type="text" title="Store Contact Number" placeholder="Please Enter Store Contact Number" autocomplete="off" value="{{ @$shop->store_contact_no }}">

                            <label for="phone_number" style="color: red;display:none;" class="error_code">Phone number is invalid.</label>
                            <input type="hidden" class="contact_code"  name="contact_code" value="{{ (@$shop->country_std_code)?@$shop->country_std_code:"+1" }}">
                            <input type="hidden" class="country_name"  name="country_name" value="{{ (@$shop->country_name)?@$shop->country_name:"United States: +1" }}">
                            <input type="hidden" class="country_code" name="country_code" value="{{ (@$shop->country_code)?@$shop->country_code:"us" }}">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control googlemapshown1 store_address" id="store_address" name="store_address" type="text" title="Store Address" placeholder="Please Enter Store Address" autocomplete="off" value="{{ @$shop->store_address }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-group pro_offer_sec">
                            ...
                            <table style="width:100%;">
                                <tr>
                                    <th><label class="col-form-label">Shop Opening/Closing Time</label></th>
                                    <th></th>
                                    <th></th>
                                    <th class="align-right">
                                        <a href="javascript:void(0);" class="add_tc_row">
                            ...
                            <table style="width:100%;">
                                <tbody class="append_term_row">
                                    <tr>
                                        <th>Week Day Name <span style="color:red;">*</span></th>
                                        ...
                                        foreach (@$shop->shopTiming as $infor) {
                                            ...
                                            <tr>
                                                <td align="top">
                                                    <select name="day_name[]" class="form-control">
                                                        <option value="">Day Name</option>
                                                        <option value="1" <?php echo (@$infor->day_name == "1") ? 'selected="selected"' : ""; ?>>Monday</option>
                                                        <option value="2" <?php echo (@$infor->day_name == "2") ? 'selected="selected"' : ""; ?>>Tuesday</option>
                                                        <option value="3" <?php echo (@$infor->day_name == "3") ? 'selected="selected"' : ""; ?>>Wednesday</option>
                                                        <option value="4" <?php echo (@$infor->day_name == "4") ? 'selected="selected"' : ""; ?>>Thursday</option>
                                                        <option value="5" <?php echo (@$infor->day_name == "5") ? 'selected="selected"' : ""; ?>>Friday</option>
                                                        <option value="6" <?php echo (@$infor->day_name == "6") ? 'selected="selected"' : ""; ?>>Saturday</option>
                                                        <option value="7" <?php echo (@$infor->day_name == "7") ? 'selected="selected"' : ""; ?>>Sunday</option>
                                                    </select>
                                                </td>
                                                <td align="top">
                                                    <input type="text" name="start_time[]" value="{{ @$infor->start_time }}" placeholder="Please select start time" class="form-control start_time">
                                                </td>
                                                <td align="top">
                                                    <input type="text" name="end_time[]" value="{{ @$infor->end_time }}" placeholder="Please select end time" class="form-control end_time">
                                                </td>
                                                <td align="top">
                                                    <a href="javascript:void(0);" class="remove_row_tc" data-id=""><i class="fas fa-minus"></i></a>
                                                </td>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="description">{{ @$shop->discription }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline form-check-sm mr-2">
                                <input type="radio"  class="form-check-input" id="inline-radio1" name="status" value="1" <?php echo (@$shop->status == "1") ? 'checked="checked"' : ""; ?>>
                                <label class="form-check-label" for="inline-radio1">Active</label>
                            </div>
                            <div class="form-check form-check-inline form-check-sm mr-2">
                                <input type="radio" class="form-check-input" id="inline-radio2" name="status" value="0" <?php echo (@$shop->status == "0") ? 'checked="checked"' : ""; ?>>
...
telInput.intlTelInput({
    ...
    initialCountry: "{{ (@$shop->country_code)?@$shop->country_code:us }}",
