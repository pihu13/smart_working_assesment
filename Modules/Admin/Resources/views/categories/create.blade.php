                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input class="form-control color_code" id="color_code" value="{{ old("color_code") }}" name="color_code" type="text" title="BG Color" placeholder="Please Enter Color Code" autocomplete="off">
